...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pGround->LoadMesh("C:/Users/Kasax/source/repos/Content/quad.obj")) {
            return false;
        }
        
        if (!m_billboardList.Init("C:/Users/Kasax/source/repos/Content/monster_hellknight.png")) {
            return false;
        }
               
        m_pTexture = new Texture(GL_TEXTURE_2D, "C:/Users/Kasax/source/repos/Content/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "C:/Users/Kasax/source/repos/Content/normal_map.jpg");
