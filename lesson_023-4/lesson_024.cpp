...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pQuad->LoadMesh("C:/Users/Kasax/source/repos/ogldev_ru/Content/quad.obj")) {
            return false;
        }

        m_pGroundTex = new Texture(GL_TEXTURE_2D, "C:/Users/Kasax/source/repos/ogldev_ru/Content/test.png");
        ...
        return m_pMesh->LoadMesh("C:/Users/Kasax/source/repos/ogldev_ru/Content/phoenix_ugv.md2");
    }
